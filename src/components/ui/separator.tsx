...
export default function Separator({ variant = "circles" }: SeparatorProps) {
  ...
  const patterns = {
    ...
    "candy-cane": `${svgStart}%3Crect x='0' y='0' width='24' height='20' fill='${color}'/%3E%3Cpath d='M 0 20 L 24 0' stroke='%23fdfbfe' stroke-width='4'/%3E${svgEnd}`,
  };
