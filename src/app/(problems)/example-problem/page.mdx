...
<CoverImage src="/problem-assets/example-problem/cover.jpg" alt="Vilenjaci" />
...
<InputChecker
  inputFileUrl="/problem-assets/example-problem/input.txt"
  checkerFileUrl="/problem-assets/example-problem/tester.py"
/>
